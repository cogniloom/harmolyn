...
export const ServerRail: React.FC<ServerRailProps> = ({ servers, activeServerId, connectionState, onSelectServer, onCreateServer, showExplore = true, homeBadge = 0 }) => {
  ...
  return (
    <div className="w-[70px] shrink-0 bg-bg-0 flex flex-col items-center py-3 gap-2 overflow-hidden border-r border-white/5 z-20 h-full" role="navigation" aria-label="Spaces">
      {/* Home Button */}
